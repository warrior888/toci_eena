...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "/cms_edytor/images/";
		
		// Popups Directory
		this.PopupsDir = "popups/";
		
		// CSS Directory File
		this.CSSFile = "/cms_edytor/styles/wysiwyg.css";		
...
var WYSIWYG_Table = {
	...
	{
		//wykosilem highligting bo zle dziala - rozumiem, ze na potrzeby edycji mozna pokazac gdzie jest np tabela, jednak po zatwierdzeniu pewnych zmian tabela ma byc na stronie niewidoczna
		//a ten highligting powoduje, ze nadal ja widac (powinien byc stosowany tylko przy edycji)
		...
		WYSIWYG_Core.setAttribute(node, "style", "border:1px dashed #AAAAAA;");*/ //no highlighting
	},
