<?php
    ...
    else
    {
        ...
        $manager = new HtmlToPdfManager();
            ...
            //var_dump($rowDeal['msc_ur'], $rowDeal['ulica'], $rowDeal['imie']);
            ...
            <div>'.$persPrefs[$rowDeal['id_plec']]['panem'].' '.own_iconv('ISO-8859-2', 'UTF-8', $rowDeal['imie']).' '.own_iconv('ISO-8859-2', 'UTF-8', $rowDeal['nazwisko']).', ur. '.$rowDeal['data_urodzenia'].', '.
            own_iconv('ISO-8859-2', 'UTF-8', $rowDeal['msc_ur']).', '.$persPrefs[$rowDeal['id_plec']]['zamieszkalym'].' w miejscowości '.$rowDeal['kod'].' '.own_iconv('ISO-8859-2', 'UTF-8', $rowDeal['msc']).', ul. '.
            own_iconv('ISO-8859-2', 'UTF-8', $rowDeal['ulica']).' jako osobę kierowaną do pracy za granicą u zagranicznego pracodawcy, zwaną dalej "Kandydatem"</div>';
...
Pośrednika pracy o godności: ".own_iconv('ISO-8859-2', 'UTF-8', $rowDeal['konsultant']).", 
zwanego dalej \"Agencją\",</div>
            ...
            $agreementHtml .= '<div>1.  Pracodawca zagraniczny: E&A Uitzendbureau, Emma Goldmanweg 8h, 5032 MN Tilburg / oddział: '.$rowDeal['biuro'].' Holandia<br /><br />
2.  Okres zatrudnienia: Umowa o pracę pracownika czasowego zostanie zawarta z zagranicznym pracodawcą na podstawie przepisów prawa holenderskiego i dotyczyć będzie zatrudnienia pracownika w fazie A do 78 tygodni, 
minimum '.$rowDeal['ilosc_tyg'].' tygodni.
<br />
3.  Warunki zatrudnienia u zagranicznego pracodawcy:<br />
-    funkcja/sektor:         '.own_iconv('ISO-8859-2', 'UTF-8', $rowDeal['stanowisko']).',<br />
-    data rozpoczęcia:        '.$rowDeal['data_wyjazdu'].',<br />
stawka godzinowa brutto:    według pracodawcy użytkownika: '.own_iconv('ISO-8859-2', 'UTF-8', $StawkaPrac).' &#8364;.<br /> 
Dodatki/potrącenia:';
            ...
            {
                $agreementHtml .= "            - ".own_iconv('ISO-8859-2', 'UTF-8', $WarKlient['nazwa']).": ".own_iconv('ISO-8859-2', 'UTF-8', $WarKlient['szczegoly']).",<br />";
            }
            //- liczniki (opomiarowane media: woda, prąd, gaz).<br />
$agreementHtml .= "</div>";
$ubezpieczenie = 'Ubezpieczenie zgodnie z holenderskim ustawodawstwem w Zorg en Zekerheid. 
Płatne przez pracownika proporcjonalnie do przepracowanego okresu z możliwością objęcia nim okresów urlopowych (pobyt w Polsce). 
Wariant ubezpieczenia umożliwia pozyskanie formularza E106.';
...
Pracownik czasowy po przepracowaniu 26 tygodni w ciągu roku w jednym biurze pośrednictwa pracy ma możliwość odprowadzania składek celem uzyskania świadczeń emerytalnych.
<br />

-    Dodatkowe, nieobowiązkowe ubezpieczenie od następstw nieszczęśliwych wypadków (i chorób tropikalnych):
<br />

Pracodawca holenderski nie ma obowiązku objęcia tym ubezpieczeniem pracowników; pozostaje ono w gestii kandydata.
<br />
5. Obowiązki i uprawnienia Kandydata: <br />
     ...
     -  zgłaszanie Agencji zatrudnienia swoich urlopów z minimum 3-tygodniowym<br /> 
        wyprzedzeniem,<br />
     -  zgłoszenie u pracodawcy zagranicznego faktu przerwania pracy z 1-dniowym wyprzedzeniem <br /> 
        z zastrzeżeniem obowiązku pokrycia przez kandydata kosztów administracyjnych <br /> 
        w kwocie 150 PLN w razie nie dokonania takiego zgłoszenia,<br />
     -  odcinek wypłaty, <br />
     -  bezpłatny dojazd z miejsca zakwaterowania do pracy (rower, bus),<br />
     -  posiadanie i dysponowanie kartą płatniczą na terenie Holandii jest obowiązkowe,<br />
     -  posiadanie do własnej dyspozycji śpiwora z poduszką i prześcieradłem oraz garnka, talerza, kubka i sztućców jest obowiązkowe,<br />
     -  prawo do odpłatnego zakwaterowania za granicą, które powinno być utrzymane w czystości 
        i zdane w nie pogorszonym stanie z odpowiedzialnością za ewentualne wyrządzone szkody.
<br />
...
-  wsparcie Kandydata w znalezieniu nowego zlecenia, gdyż zgodnie z Układem Zbiorowym Pracy dla pracowników czasowych rozwiązanie umowy w fazie A może nastąpić w każdej chwili, również w przypadku choroby lub wypadku pracownika,<br />
<br />
...
<br />
7. Agencja ani pracodawca holenderski nie pobiera opłat od pracownika w związku ze 
    skierowaniem go do pracy za granicą. Kandydat ponosi we własnym zakresie koszty, 
    przejazdu pomiędzy Polską a Holandią, zaświadczenia o niekaralność wraz z pełnomocnictwem, 
    koszty tłumaczenia dokumentów, a także badań lekarskich, a w razie ich poniesienia przez Agencję Pracownik zobowiązany 
    jest do ich zwrotu w wysokości faktycznie poniesionej przez Agencję 
    (art. 85 ust. 2 pkt 7a ustawy z dnia 20-04-2004 o promocji zatrudnienia i instytucjach rynku pracy).
            </div>';    
...
8.  Kandydat oświadcza, że: <br />
 - honorowany przez agencję rachunek bankowy kandydata, założony w banku '.own_iconv('ISO-8859-2', 'UTF-8', $r7['bank']).", o numerze: ".$r7['nr_konta'].' jest rachunkiem, 
na którym kandydat oczekuje wynagrodzeń z tytułu wykonywanej pracy,<br /> 
- dysponuje aktualnym do '.$r7['data_waznosci'].' dokumentem tożsamości o nr: '.$r7['pass_nr'].', 
zgodnie z którym spełnia tryb i warunek dopuszczenia go do pracy w Holandii,<br />
...
11. Umowa o pracę z pracodawcą zagranicznym będzie zawarta na podstawie prawa holenderskiego, a wszelkie jej spory będą rozstrzygane w oparciu o Układ Zbiorowy Pracy dla pracowników czasowych, przepisy ustawy chorobowej opartej o wypłaty przez Zrzeszenie Ubezpieczeń Pracowniczych, oraz o Fundację Funduszu Emerytalnego Pracowników Czasowych.<br /><br />
...
14. Poprzez złożenie podpisu kandydat wyraża zgodę na przetwarzanie swoich danych osobowych zawartych w niniejszym formularzu dla potrzeb realizacji procesu
 rekrutacji zgodnie Ustawą z dnia 29 sierpnia 1997 r o ochronie danych osobowych. ( Dz. U. Nr 133, poz. 883 ze zm.). Kandydat przyjmuje do wiadomości,
  że przysługuje mu prawo wglądu do treści jego danych, prawo ich poprawiania i uzupełniania oraz wniesienia żądania o zaprzestaniu ich przetwarzania.<br /><br />
