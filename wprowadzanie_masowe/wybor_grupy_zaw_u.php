...
<?php
    ...
    else
    {
        ...
        if (isset($_POST['potw_gr_zaw']))
        {
            ...
            $Filter = "select id, nazwa from zawod where lower(nazwa) like lower('%".$_POST['grupa_zawodowa']."%') order by nazwa asc;";
            ...
            while ($row = pg_fetch_array($result))
            {
                ...
                onclick='opener.window.document.getElementById(\"destOccIdU\").value = \"".$row['id']."\";
                opener.window.document.getElementById(\"destOccU\").value = \"".$row['nazwa']."\";
        ...
        echo "</table>";
        /*echo "var e = opener.window.document.getElementById(\"3\");
                    e.value = '".$_POST['ilosc_tyg_www']."';
                    var e = opener.window.document.getElementById(\"2\");
                    e.value = '".$wiersz['data_wyjazdu']."';";
